...
const SollenProductScreen = () => {
  ...
  return (
    <div className="container">
      <h1 className='large'>Catalogue Solen</h1>
                ...
                if (product) {
                  return (
                    <tr key={product.id}>
                      ...
                      <td>
                        {Math.round(product.multiprices?.['1'] ?? '0')} XPF
                      </td>
                      <td>
                        {Math.round(product.multiprices?.['2'] ?? '0')} XPF
                      </td>
                      <td>
                        {Math.round(product.multiprices?.['3'] ?? '0')} XPF
                      </td>
                      <td>
